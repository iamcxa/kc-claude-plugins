...
If a worker receives that inapplicable dispatch, report the mismatch to FO rather
than adding review ceremony. Eligibility remains an integration proof obligation.
