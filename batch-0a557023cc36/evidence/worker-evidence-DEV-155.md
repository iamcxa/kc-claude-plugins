## Evidence
DISPATCH_TOKEN: dev155-2026-09-10-r4
CANDIDATE_SHA: 66a1ffbf1b7a76c769af3ab0d2e9a17cb9d08973
...
## Round 3 (66a1ffbf): moved_base merge; cases build their own throwaway repository (no history pin); unreachable BASE_SHA refuses exit 2 'BASE_SHA not reachable' before the diff; the three history-pinned fixtures deleted. CI 3/3 green. FO: shallow clone (depth 1) contract-test exit 0; round-2 station in the shallow clone fails the new case. without-it unanswered: 14 other unreferenced fixtures pin real SHAs (dead; DEV-130 class).
