## Evidence
DISPATCH_TOKEN: dev151-2026-09-09-r3
CANDIDATE_SHA: 6cd2c881e3343a8af1a03be6d4a1f86ea77699a2
...
WITHOUT_IT_COMMAND: out=$(bash kc-ship-flow/scripts/open-pr.sh kc-ship-flow/scripts/fixtures/open-pr/evidence-suite-filter.md kc-ship-flow/scripts/fixtures/open-pr/batch --dry-run --what-changed-file kc-ship-flow/scripts/fixtures/open-pr/what-changed.txt) && ! printf '%s' "$out" | grep -qF 'evidence.md: exit 0'
WITHOUT_IT_REMOVED_VARIANT: git show 82cdaca9c1e639ca53fc9a81f2d4ef97f11f22dd:kc-ship-flow/scripts/open-pr.sh > kc-ship-flow/scripts/open-pr.sh
