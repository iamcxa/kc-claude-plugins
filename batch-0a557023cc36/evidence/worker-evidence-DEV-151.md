## Evidence
DISPATCH_TOKEN: dev151-2026-09-10-r4
CANDIDATE_SHA: 87f0de588547bed35c8db292ae5dc16ea7eaca34
...
## Round 4 (87f0de58, Captain-re-signed third repair): moved_base merge; F1 empty lead refused / --lead rescues; F2 --fixes per issue (FO mutation of the loop fails the multi-branch case); F3 bare suite name admitted + stderr notice; F4 contract cases for --lead, lead required, --evidence-file; F5 backtick quotes. contract-test 0; CI green; this PR's body regenerated by the final script (100 words, Evidence from the bare `contract-test` token).
