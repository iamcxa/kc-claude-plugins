...
const plugin = resolve(root, 'layer-3/kc-journey-map');
...
const evidence={tree:'1738d173046d750819cd40e8ee838dd3eace114e',kind:'refusal',seam:'real server PATCH -> journey-read CLI --out -> YAML identity',cases:[]};
try {
