...
| MP4 video | MP4 (2x speed, smart dedup) | Generated by `e2e-media-processor` agent (duplicate frames dropped + sped up) |
...
| `test-run.mp4` / `walkthrough.mp4` | 2x speed MP4 for sharing (auto-converted from WebM) |
...
| MP4 (browser) | 2x playback speed, smart dedup | 2s trim from start (browser chrome), full WebM -> MP4 conversion |
