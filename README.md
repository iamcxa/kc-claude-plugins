...
|--------|---------|-------------|---------|
| [e2e-pipeline](./e2e-pipeline/) | 1.5.0 | Browser E2E testing with context-isolating subagents — map UI, run tests, walk through apps, record video | `/plugin install e2e-pipeline@kc-claude-plugins` |
