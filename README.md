...
**Prerequisite:** `gh` CLI authenticated. Optional: `pr-review-toolkit` (provides the 5 review agents), `feature-dev`, `superpowers` marketplace plugins for graceful enhancement.
