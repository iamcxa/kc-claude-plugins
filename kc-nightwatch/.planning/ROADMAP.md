...
|-------|------|-------|--------|
| 15 | Data Layer Foundations | 2 | In Progress (1/2 complete) |
| 16 | Visualization Frontend | TBD | Not Started |
| 17 | Auto-Calibration + Signal Priority | TBD | Not Started |
