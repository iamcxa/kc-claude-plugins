...
3. `spacedock-project-status-updates` (`16`), after the projection snapshot and Draft identity contracts are stable
...
a versioned deterministic status snapshot. Projector-owned Draft items expose
