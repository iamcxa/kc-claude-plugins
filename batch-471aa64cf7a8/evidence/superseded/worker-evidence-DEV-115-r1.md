## Evidence
DISPATCH_TOKEN: dev115-2026-09-06
CANDIDATE_SHA: 690c5b6180f565ac8ab00b7b71071ef3629f0d34
...
FILES: .claude-plugin/marketplace.json,.github/workflows/kc-ship-flow.yml,.release-please-manifest.json,kc-ship-flow/.claude-plugin/plugin.json,kc-ship-flow/.codex-plugin/plugin.json,kc-ship-flow/references/kernel.md,kc-ship-flow/scripts/contract-test.py,release-please-config.json
...
SELF_CHECK: 2026-09-06T12:34:19Z accept-evidence: ACCEPT
