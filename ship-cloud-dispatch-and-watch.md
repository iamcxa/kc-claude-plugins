...
reading the transcript tail only through `conductor sql`. `docs/ship/README.md` is re-commissioned
...
work_profile:
  ...
  obligations:
    ...
    implementation: [dispatch.sh with dry-run and claim fence; watch.sh with the four exits; README re-commission]
    testing: [AC-1 and AC-2 on fixtures; AC-3 on the real sprint; AC-4 on the README]
