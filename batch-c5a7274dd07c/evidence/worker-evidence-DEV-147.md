...
WITHOUT_IT_COMMAND: python3 docs/plan-flow/schema/close-receipt.test.py
WITHOUT_IT_REMOVED_VARIANT: git show 66851037:docs/plan-flow/schema/validate-receipt.py > docs/plan-flow/schema/validate-receipt.py
