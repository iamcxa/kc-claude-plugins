...
TESTS: python3 kc-ship-flow/scripts/contract-test.py -> exit 0; bash kc-ship-flow/scripts/open-pr.sh kc-ship-flow/scripts/fixtures/open-pr/evidence.md kc-ship-flow/scripts/fixtures/open-pr/batch --dry-run -> exit 0
