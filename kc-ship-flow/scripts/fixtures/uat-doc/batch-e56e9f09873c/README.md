...
- 2026-09-06T02:23:34Z — **PRs opened with DEV-104's own `open-pr-script`** from its candidate (dogfood of the station under build): DEV-104 → #378, DEV-105 → #379. Default `pr_creation: batch_approve_draft`.
