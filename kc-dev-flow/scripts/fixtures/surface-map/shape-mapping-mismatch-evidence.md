...
SURFACE: scripts/ship-flow/parse-execute-external.py -> AC-2 | scripts/ship-flow/parse-execute-external.py --self-test | git rm -f scripts/ship-flow/parse-execute-external.py
