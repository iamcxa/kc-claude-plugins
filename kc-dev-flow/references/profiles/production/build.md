...
contract declared; do not continue past it. Use scoped iteration checks and one
relevant exit suite. Return changed premises to their owner; do not start an
unbounded reviewer loop.
