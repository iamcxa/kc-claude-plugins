...
- **Exploration Brief** — required for POC; uses the existing v3 decision,
  ...
  and assumptions. POC need not create `docs/architecture.md`; retained POC work
  still needs a proportional linked explanation. Pilot/Production requires that
...
| `project-context-maintenance.md` | A Pilot/Production map is missing, an initial retained explanation is needed, or accepted behavior, architecture, or a public contract may change a bound claim. |
